<%@ include file="papersSearch.html" %>
...
<%
    String papersSubject = request.getParameter("papersSubject");
    try {
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/faiz", "root", "root");
        PreparedStatement ps = conn.prepareStatement("select * from giveaway_papers where subject_name=?");
        ps.setString(1, papersSubject);
